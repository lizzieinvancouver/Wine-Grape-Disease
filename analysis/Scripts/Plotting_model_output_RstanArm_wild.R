...
mpd_single_sp_in_genus_majorpathogens_wildhosts <- read.csv("mpd.single.sp.in.genus_majorpathogens_wildhosts.csv")
mpd_single_sp_in_genus_wild <- read.csv("mpd.single.sp.in.genus_wild.csv")
...
colnames(mpd_single_sp_in_genus_majorpathogens_wildhosts)[1] <- "pest"
colnames(mpd_single_sp_in_genus_wild)[1] <- "pest"
...
mpd_single_sp_in_genus_wild <- bind_rows(mpd_single_sp_in_genus_majorpathogens_wildhosts, mpd_single_sp_in_genus_wild)

Yieldloss3.0 <- merge(mpd_single_sp_in_genus_wild, Yieldloss3.0, by= "pest")
...
########impact model with single species in mpd
### testing a prediction
##### Inverselogit with MPD
#### Invlogit 
#converts impact to inverse logit
